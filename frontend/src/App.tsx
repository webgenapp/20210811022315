...
import ListCookie from './cookies/ListCookie'
import DetailCookie from './cookies/DetailCookie'
  ...
  return (
    <Router>
      <nav>
        <ul className='flex'>
          ...
          <li className='ml-10'>
            ...
            <br />
            <Link to='/cookies/create'>Create a Cookie</Link>
            <br />
          </li>
      ...
      <main>
        ...
        <Switch>
          {/* Cookie routes */}
          <Route path='/cookies/create' component={CreateCookie} />
          <Route path='/cookies/update/:id' component={UpdateCookie} />
          <Route path='/cookies/detail/:id' component={DetailCookie} />
          <Route path='/cookies' component={ListCookie} />,{/* User routes */}
